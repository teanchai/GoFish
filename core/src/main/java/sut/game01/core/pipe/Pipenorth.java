...
public class Pipenorth  {
    ...
    public Pipenorth(final float x, final float y, final World world) {

        sprite = SpriteLoader.getSprite("images/pipenorth.json");
    ...
    private Body initPhysicsBody(World world, float x, float y){
        ...
        shape.setAsBox(sprite.width() * TestScreen.M_PER_PIXEL/2 ,
                sprite.height()* TestScreen.M_PER_PIXEL /2);
