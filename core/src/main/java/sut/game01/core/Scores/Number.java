...
public class Number  {
    ...
    public Number(final float x, final float y) {
        ...
        switch (state){
            ...
            case NUMBER0 : state=State.NUMBER0;break;
            case NUMBER1 : state=State.NUMBER1;break;
            case NUMBER2 : state=State.NUMBER2;break;
            case NUMBER3 : state=State.NUMBER3;break;
            case NUMBER4 : state=State.NUMBER4;break;
            case NUMBER5 : state=State.NUMBER5;break;
            case NUMBER6 : state=State.NUMBER6;break;
            case NUMBER7 : state=State.NUMBER7;break;
            case NUMBER8 : state=State.NUMBER8;break;
            case NUMBER9 : state=State.NUMBER9;break;
        }
